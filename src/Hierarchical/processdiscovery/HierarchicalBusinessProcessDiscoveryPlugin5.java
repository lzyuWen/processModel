...
@Plugin(
		name = "Hierarchical Business Process Model Discovery5",// plugin name
		
		returnLabels = {"log"}, //return labels
		returnTypes = {XLog.class},//return class, a cross-organization process model
...
public class HierarchicalBusinessProcessDiscoveryPlugin5 {
	@UITopiaVariant(
	        affiliation = "TU/e", 
	        author = "Cong liu", 
	...
	@PluginVariant(
			variantLabel = "Hierarchical Business Process Model Discovery, default",
			// the number of required parameters, 0 means the first input parameter 
			requiredParameterLabels = {0})
	public XLog HierarchicalBehaviorDiscovery(UIPluginContext context, XLog lifecycleLog) throws UserCancelledException 
	{
...
//		System.out.println("Root Activities: "+rootActivities); 
		...
		HEventLog hlog1 =hlog.getSubLogMapping().get(ang);
		return hlog1.getMainLog();
